...
const Sidebar = () => {
  ...
  return (
    <>
      {/* Mobile Menu Button */}
      <div className="md:hidden flex items-center px-4 py-3 border-b bg-white">
        <MdMenu size={26} className="cursor-pointer" onClick={() => setOpen(true)} />
      </div>
      ...
      >
        ...
        <div className="flex items-center justify-between px-6 py-5">
          ...
          <MdClose size={22} className="md:hidden cursor-pointer" onClick={() => setOpen(false)} />
        </div>

        {/* Nav */}
        <nav className="px-4 space-y-4 mt-8">
