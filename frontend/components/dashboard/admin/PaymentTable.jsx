            ...
            <table className="w-full border rounded-2xl">
                <thead>
                    <tr className="bg-[#F5F7FA]">
                        ...
                        <th className="px-4 py-2 text-left text-sm font-semibold">No. of Bookings</th>
                        <th className="px-4 py-2 text-left text-sm font-semibold">Platform Fee</th>
                        <th className="px-4 py-2 text-left text-sm font-semibold">Total Fee</th>
                    </tr>
                </thead>
                <tbody>
