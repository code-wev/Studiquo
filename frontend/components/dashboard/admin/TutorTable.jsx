  ...
  return (
    <div className='container mx-auto p-4'>
      ...
      <div className='flex items-center justify-between mb-6'>
        <div>
          <h2 className='text-2xl font-bold text-gray-800'>Tutor List</h2>
            ...
            {tutors.length === 0 ? (
              ...
              tutors.map((tutor, index) => (
                <tr
                  ...
                  {/* Email */}
                  <td className='p-4 text-gray-600'>{tutor?.email || "N/A"}</td>
                  ...
                  <td className='p-4'>
                    <div className='flex justify-end gap-2'>
                      <button
                        onClick={() =>
                          handleTutorAction(tutor._id, tutor.isApproved)
                        }
      ...
      {paginationInfo.totalPages > 1 && (
        <div className='flex items-center justify-between mt-6'>
          <div className='text-sm text-gray-600'>
            ...
            {Math.min(currentPage * limit, paginationInfo.total)} of{" "}
            {paginationInfo.total} tutors
          </div>
