...
import { useGetExamBoardQuery, useUpdateBoardMutation } from '@/feature/student/StudentApi';
                  ...
                  <tr key={subject.id} className="border-b border-gray-100 hover:bg-gray-50">
                    <td className="p-4">
                      <div className="flex items-center">
                        <span className={`inline-block px-3 py-1 rounded text-sm font-medium ${colors.bg} ${colors.text} border ${colors.border}`}>
                          {subject.name}
                        </span>
                      </div>
                    </td>
